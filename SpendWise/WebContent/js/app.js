							...
							try{	
								...
								try{	
									...
									try{	
										...
										try{	
											document.getElementById('12') && Highcharts.chart('12', {
											    chart: {
											        type: 'pie',
											        options3d: {
											            enabled: true,
											    ...
											    title: {
											        text: 'PRIMECAP Odyssey Aggressive Growth'
											    },
											    tooltip: {
											        pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
											    },
											    ...
											    series: [{
											        ...
											        data: [
											            ...
											            ['Large Cap Stocks', 30.0],
											            ['Mid Cap Stocks', 10.0],
											            ['Small and Micro Cap Stocks', 20.0]
											        ]
											    }]
											});}catch(error){
												console.log(error);
											...
											try{	
												document.getElementById('13') && Highcharts.chart('13', {
												    chart: {
												        type: 'pie',
												        options3d: {
												            enabled: true,
												    ...
												    title: {
												        text: 'AJ umam Growth Aggressive Fund'
												    },
												    tooltip: {
												        pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
												    },
												    ...
												    series: [{
												        ...
												        data: [
												            ...
												            ['Large Cap Stocks', 15.0],
												            ['Mid Cap Stocks', 25.0],
												            ['Small and Micro Cap Stocks', 35.0]
												        ]
												    }]
												});}catch(error){
													console.log(error);
