...
<link rel="stylesheet"
       href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css"></link>
		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu">
					...
					<li><a class="" href="accounts.html"> <i
							class="icon_documents_alt"></i> <span>Accounts</span>
					</a></li>
					<li><a class="" href="reports.html"> <i
							class="icon_piechart"></i> <span>Spending</span>
					</a></li>
					<li><a class="" href="products.html"> <i
							class="icon_desktop"></i> <span>Products</span>
					</a></li>
					<li><a class="" href="savekittys.html"> <i
			...
			options : {
				...
				<div class="row">
					<div class="col-md-12 portlets">
						<section class="panel">
							<header class="panel-heading"> Spend Wisely!!!! </header>
                                                ...
                                                <div class="panel-body">
                                                       <div class="panel panel-primary">
                                                              ...
                                                              <div class="panel-content">Paragraphs are the building
                                                                     ...
                                                                     sentences or a single sentence that forms a unit” (Lunsford
