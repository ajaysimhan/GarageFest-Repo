		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a class="" href="accounts.html"> <i
					...
					<li><a class="" href="savekitty.html"> <i
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="icon_documents_alt"></i>Accounts
						</h3>
						<ol class="breadcrumb">
							...
							<div class="panel-body">
								<form class="form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" id="title"
												value="${account.getAccountName()}" readonly>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" id="title"
												value="${account.getAccountNumber()}" readonly>
										</div>
									</div>

									<div class="form-group">
										<label class="control-label col-lg-2" for="title">Balance
										</label>
										<div class="col-lg-10">
											<input type="text" class="form-control" id="title"
				...
				<div class="row">
					<div class="col-md-12 portlets">
						<section class="panel">
							<header class="panel-heading"> Congratulations!!!! </header>
							<div class="panel-body">
