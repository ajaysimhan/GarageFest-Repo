		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu">
					...
					<li><a class=""> <i
							class="icon_documents_alt"></i> <span>Accounts</span>
					</a></li>
					<li><a class=""> <i
							class="icon_piechart"></i> <span>Spending</span>
					</a></li>
					<li><a class=""> <i
							class="icon_desktop"></i> <span>Products</span>
					</a></li>
					<li><a class="" href="savekittys.jsp"> <i
							class="icon_genius"></i> <span>Save Kitty</span>
					</a></li>
					<li><a class="" href="templateindex.html"> <i
							class="icon_genius"></i> <span>Template UIS</span>
					</a></li>
				</ul>
				<!-- sidebar menu end-->
			</div>
						...
						<div class="col-md-12 portlets">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									Do you hate it when you really need money, but your wallet is
									empty? No matter how little or how much money you have,
									spending it wisely is a good idea; it enables you to get the
									most bang for your buck. Follow these tips to reduce
									expenditures in key areas and adopt a safer overall approach to
									shopping. </br>
									</br>
									</br> More BLAH BLAH BLAH </br>
									</br>
									</br>
